...
export const CATALOG: Record<string, Arrangement> = {
  ...
  'fall-burnt-ember-petite': {
    ...
    amount: 9500,
    description: '4–6" vessel. Rust and café au lait dahlias, terracotta butterfly ranunculus, trailing amaranthus, copper beech, chocolate cosmos.',
  ...
  'fall-burnt-ember-signature': {
    ...
    amount: 15500,
    description: '7–9" vessel. Rust and café au lait dahlias, terracotta butterfly ranunculus, trailing amaranthus, copper beech, chocolate cosmos.',
    collection: 'The Fall Edit — Centerpieces',
    size: 'Signature',
    image: BASE + 'fall-burnt-ember.webp',
  },
  'fall-burnt-ember-statement': {
    ...
    amount: 24500,
    description: '12–16" vessel. Rust and café au lait dahlias, terracotta butterfly ranunculus, trailing amaranthus, copper beech, chocolate cosmos.',
    collection: 'The Fall Edit — Centerpieces',
    size: 'Statement',
    image: BASE + 'fall-burnt-ember.webp',
  },
  ...
  'fall-olive-smoke-petite': {
    ...
    amount: 9500,
    description: '4–6" vessel. Olive branch, smokebush, green hellebore, white spider chrysanthemum, nigella and scabiosa pods.',
    collection: 'The Fall Edit — Centerpieces',
    size: 'Petite',
  ...
  'fall-olive-smoke-signature': {
    ...
    amount: 15500,
    description: '7–9" vessel. Olive branch, smokebush, green hellebore, white spider chrysanthemum, nigella and scabiosa pods.',
    collection: 'The Fall Edit — Centerpieces',
    size: 'Signature',
    image: BASE + 'fall-olive-smoke.webp',
  },
  'fall-olive-smoke-statement': {
    ...
    amount: 24500,
    description: '12–16" vessel. Olive branch, smokebush, green hellebore, white spider chrysanthemum, nigella and scabiosa pods.',
    collection: 'The Fall Edit — Centerpieces',
    size: 'Statement',
    image: BASE + 'fall-olive-smoke.webp',
  },
  ...
  'fall-mahogany-dusk-petite': {
    ...
    amount: 9500,
    description: '4–6" vessel. Burgundy dahlias, antique dusty-rose garden roses, chocolate cosmos, plum scabiosa, astilbe, clematis vine.',
    collection: 'The Fall Edit — Centerpieces',
    size: 'Petite',
  ...
  'fall-mahogany-dusk-signature': {
    ...
    amount: 15500,
    description: '7–9" vessel. Burgundy dahlias, antique dusty-rose garden roses, chocolate cosmos, plum scabiosa, astilbe, clematis vine.',
    collection: 'The Fall Edit — Centerpieces',
    size: 'Signature',
    image: BASE + 'fall-mahogany-dusk.webp',
  },
  'fall-mahogany-dusk-statement': {
    ...
    amount: 24500,
    description: '12–16" vessel. Burgundy dahlias, antique dusty-rose garden roses, chocolate cosmos, plum scabiosa, astilbe, clematis vine.',
    collection: 'The Fall Edit — Centerpieces',
    size: 'Statement',
    image: BASE + 'fall-mahogany-dusk.webp',
  },
